...
void get_four_enc_rel_handler( int16_t enc_rel_a, int16_t enc_rel_b, int16_t enc_rel_c, int16_t enc_rel_d )
{
	...
	//Save the encoder reading
	g_orangebot_platform.enc_pos( 0 ) += enc_rel_a;
	g_orangebot_platform.enc_pos( 1 ) += enc_rel_b;
	g_orangebot_platform.enc_pos( 2 ) += enc_rel_c;
	g_orangebot_platform.enc_pos( 3 ) += enc_rel_d;
...
void get_four_enc_spd_handler( int16_t enc_spd_a, int16_t enc_spd_b, int16_t enc_spd_c, int16_t enc_spd_d )
{
	...
	//Save the encoder reading
	g_orangebot_platform.enc_spd( 0 ) = enc_spd_a;
	g_orangebot_platform.enc_spd( 1 ) = enc_spd_b;
	g_orangebot_platform.enc_spd( 2 ) = enc_spd_c;
	g_orangebot_platform.enc_spd( 3 ) = enc_spd_d;
...
void get_two_enc_spd_handler( int16_t enc_spd_a, int16_t enc_spd_b )
{
	...
	//Save the encoder reading
	g_orangebot_platform.enc_spd( 0 ) = enc_spd_a;
	if (g_orangebot_platform.enc_spd( 0 ) > 32767)
	{
		g_orangebot_platform.enc_spd( 0 ) -= 65536;
	}

	g_orangebot_platform.enc_spd( 1 ) = enc_spd_b;
	if (g_orangebot_platform.enc_spd( 1 ) > 32767)
	{
		g_orangebot_platform.enc_spd( 1 ) -= 65536;
	}
...
void get_two_vnh7040_pwm_handler( int16_t pwm_a, int16_t pwm_b )
{
	...
	//Save PWM targets
	g_orangebot_platform.pwm( 0 ) = tmp;
	...
	g_orangebot_platform.pwm( 1 ) = tmp;
